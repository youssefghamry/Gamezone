...
if (!function_exists('gamezone_customizer_get_css')) {

	function gamezone_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = gamezone_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('gamezone_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(gamezone_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = gamezone_get_scheme_colors($scheme);
...
input:focus::-moz-placeholder          {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 19+ */
input:focus:-moz-placeholder           {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 18- */
input:focus:-ms-input-placeholder      {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 18- */

textarea:focus::-webkit-input-placeholder {color:{$colors['input_dark']}; opacity: 1;}
textarea:focus::-moz-placeholder          {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 19+ */
textarea:focus:-moz-placeholder           {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 18- */
textarea:focus:-ms-input-placeholder      {color:{$colors['input_dark']}; opacity: 1;}/* Firefox 18- */

input.trx_addons_field_error::-webkit-input-placeholder {color:{$colors['extra_hover']}; opacity: 1;}
input.trx_addons_field_error::-moz-placeholder          {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 19+ */
input.trx_addons_field_error:-moz-placeholder           {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 18- */
input.trx_addons_field_error:-ms-input-placeholder      {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 18- */

textarea.trx_addons_field_error::-webkit-input-placeholder {color:{$colors['extra_hover']}; opacity: 1;}
textarea.trx_addons_field_error::-moz-placeholder          {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 19+ */
textarea.trx_addons_field_error:-moz-placeholder           {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 18- */
textarea.trx_addons_field_error:-ms-input-placeholder      {color:{$colors['extra_hover']}; opacity: 1;}/* Firefox 18- */
...
.sc_button .sc_button_title, .sc_form button{
  text-shadow:0px 2px 3px {$colors['text_dark_02']};
}
...
.sc_layouts_row_type_compact .sc_layouts_item a.sc_layouts_item_link.sc_layouts_iconed_text_link.trx_addons_popup_link:hover .sc_layouts_item_icon{
	color: {$colors['text_link']};
}
...
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_icon:hover {
	color: {$colors['text_link']};
}
...
.search_style_fullscreen.search_opened .search_form_wrap {
	background-color: {$colors['extra_link2_09']};
}
...
.search_style_fullscreen.search_opened .search_field::-webkit-input-placeholder {color:{$colors['inverse_text']}; opacity: 1;}
.search_style_fullscreen.search_opened .search_field::-moz-placeholder          {color:{$colors['inverse_text']}; opacity: 1;}/* Firefox 19+ */
.search_style_fullscreen.search_opened .search_field:-moz-placeholder           {color:{$colors['inverse_text']}; opacity: 1;}/* Firefox 18- */
.search_style_fullscreen.search_opened .search_field:-ms-input-placeholder      {color:{$colors['inverse_text']}; opacity: 1;}
...
.sheme_self.sidebar .gamezone_tabs .gamezone_tabs_titles li.ui-state-active a {
...
.search-results .format-audio .post_featured{
	background-color: {$colors['text_dark']};
}
...
.post_layout_excerpt .post_info_top .post_categories a, 
.post_layout_classic .post_featured .post_categories a{
	text-shadow:1px 1px 1px {$colors['text_dark_04']};
	color: {$colors['inverse_text']};
}
.post_layout_excerpt .post_info_top .post_categories a:hover {
	color: {$colors['text_dark']};
}
.post_layout_excerpt .post_featured .post_categories a:before, 
.post_layout_excerpt .post_categories a:before, 
...
.posts_container .post_layout_excerpt:nth-child(4n+3) .post_categories a:before, 
.posts_container .post_layout_excerpt:nth-child(4n+4) .post_categories a:before{
	background-color: {$colors['text_link']};
}

.posts_container .column-1_2:nth-child(4n+3) .post_layout_classic.post_layout_classic_2 .post_categories a:before, 
.posts_container .column-1_2:nth-child(4n+4) .post_layout_classic.post_layout_classic_2 .post_categories a:before, 
.posts_container .column-1_3:nth-child(4n+3) .post_layout_classic.post_layout_classic_3 .post_categories a:before, 
.posts_container .column-1_3:nth-child(4n+4) .post_layout_classic.post_layout_classic_3 .post_categories a:before{
	background-color: {$colors['text_link']};
}
...
.single-post .post_featured .post_info_bottom .post_categories a{
	text-shadow:1px 1px 1px {$colors['text_dark_03']};
	color: {$colors['inverse_text']};
}
.single-post .post_featured .post_info_bottom .post_categories a:before{
	background-color: {$colors['text_link3']};
}
.single-post .post_featured .post_info_bottom .post_categories a:hover{
	color: {$colors['text_dark']};
}
...
.related_item .post_featured .post_info_bottom .post_categories a{
	text-shadow:1px 1px 1px {$colors['text_dark_03']};
	color: {$colors['inverse_text']};
}
...
.related_item .post_featured .post_info_bottom .post_categories a:hover{
	color: {$colors['text_dark']};
}
...
.scheme_self.sidebar ul.wp-block-page-list li:before,
...
CSS;
					...
					$rez = apply_filters('gamezone_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'gamezone_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>