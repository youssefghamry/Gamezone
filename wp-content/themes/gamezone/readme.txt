...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Gamezone'.
Please install and activate it before starting to use the theme Gamezone.
...
Theme documentation is available on http://gamezone.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Gamezone is Fontello.
