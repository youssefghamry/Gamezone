	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
				...
				?><span class="title_widgets_contacts"><?php esc_html_e('Address:', 'gamezone')?></span><span class="contacts_address"><?php echo str_replace('|', "<br>", $address); ?></span><?php
				if ($columns) {
					?></div><?php
				}
			}
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($phone)) {
					?><span class="contacts_phone"><span class="title_widgets_contacts"><?php esc_html_e('Phone:', 'gamezone')?></span><a href="<?php echo esc_attr(trx_addons_get_phone_link($phone)); ?>"><?php echo wp_kses_data($phone); ?></a></span><?php
				}
				if (!empty($email)) {
					?><span class="contacts_email"><span class="title_widgets_contacts"><?php esc_html_e('Email:', 'gamezone')?></span><a href="mailto:<?php echo antispambot( $email); ?>"><?php echo antispambot($email); ?></a></span><?php
				}
				if ($columns) {
					?></div><?php
				}
