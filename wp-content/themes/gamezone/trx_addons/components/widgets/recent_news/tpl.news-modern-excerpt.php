		...
		if ( !in_array($post_format, array('link', 'aside', 'status', 'quote')) ) {
			...
			<div class="post_header entry-header">
				...
				<div class="second-wrap-post-info">
					<span class="post_date"><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo get_the_date(); ?></a></span>
					<?php
				...
				<div class="post_content_inner_read_more">
					<p><a class="sc_button sc_button_simple" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more', 'gamezone'); ?></a></p>
				</div>
			</div><!-- .entry-header -->
			<?php
		}
...
<article
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
		...
		apply_filters('trx_addons_filter_args_featured', array(
			'hover' => 'simple',
			'thumb_size' => gamezone_get_thumb_size('med'),
			'post_info' => '<div class="post_info"><span class="post_categories">'.trx_addons_get_post_categories().'</span></div>'
