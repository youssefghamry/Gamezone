...
?><div class="<?php echo esc_attr($sc); ?>_slider sc_item_slider slider_swiper_outer slider_outer<?php
			echo ' slider_outer_' . esc_attr(trx_addons_is_off($args['slider_controls']) 
				...
				. ' slider_outer_' . esc_attr($args['columns']>1 
						...
						: 'one');
		?>">
	<div class="slider_container swiper-slider-container slider_swiper slider_noresize<?php
