...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '20.71.02.6' );
...
if ( !function_exists( 'trx_addons_merge_styles' ) ) {
	...
	add_action( 'trx_addons_action_importer_import_end', 'trx_addons_merge_styles', 20 );
	add_action( 'activated_plugin', 'trx_addons_merge_styles', 20 );
