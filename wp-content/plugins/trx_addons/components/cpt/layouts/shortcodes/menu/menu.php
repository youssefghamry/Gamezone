				...
				"params" => array_merge(
					array(
						...
						array(
							...
							"std" => "horizontal",
							"value" => array_flip(apply_filters('trx_addons_sc_direction', array(
			...
			return apply_filters('trx_addons_sow_map', array_merge(
				array(
					...
					'direction' => array(
						...
						"description" => wp_kses_data( __("Select direction of the menu items", 'trx_addons') ),
						'default' => 'horizontal',
						'options' => apply_filters('trx_addons_sc_direction', trx_addons_get_list_sc_layouts_menu(), $this->get_sc_name()),
						'type' => 'select'
					),
					'location' => array(
