<?php
/**
 * The style "default" of the Widget "Top Popular Posts"
 *
 * @package WordPress
...
$args = get_query_var('trx_addons_args_widget_top_popular_posts');
...
<div id="<?php echo esc_attr($id); ?>" class="trx_addons_tabs<?php if ($tabs_count > 1) echo ' trx_addons_tabs_with_titles'; ?>">
	...
	foreach ($tabs as $k=>$tab) {
		...
		<div id="<?php echo esc_attr($id_tab); ?>_content" class="trx_addons_tabs_content">
			...
			<a href="<?php echo esc_url($title_link_url)?>" class="top_popular_posts_link"><?php echo esc_html($title_link)?></a>
		</div>
		<?php
	}
	?>
